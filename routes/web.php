...
Route::get('seguradora','HomeController@insurance');
Route::get('motorista','HomeController@driver');
Route::get('element','HomeController@driver');
Route::get('concessionaria','HomeController@dealer');
Route::get('cases-de-sucesso','HomeController@cases');
Route::get('contato', 'HomeController@contact');
Route::get('frota', 'HomeController@fleet');
Route::get('montadora', 'HomeController@maker');
Route::get('sobre', 'HomeController@about');
Route::get('termos', 'HomeController@terms');
Route::get('politica', 'HomeController@politics');
